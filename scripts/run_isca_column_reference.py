"""Run Isca's single-column model (grey/Frierson physics) for a short spin-up and
write daily diagnostics, as the jsca-vs-Isca SCM reference. Adapted from
...
exp = Experiment('scm_reference', codebase=cb)
