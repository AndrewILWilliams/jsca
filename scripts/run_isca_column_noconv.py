"""Run Isca's single-column model with convection_scheme='NONE' (no convective
adjustment; large-scale condensation only) for the jsca NO_CONV validation. From
...
exp = Experiment('scm_noconv', codebase=cb)
...
exp.namelist = Namelist({
    ...
    'idealized_moist_phys_nml': {'do_damping': False, 'turb': True, 'mixed_layer_bc': True,
        ...
        'convection_scheme': 'NONE', 'do_lcl_diffusivity_depth': False},
