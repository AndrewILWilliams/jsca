...
!! use_virtual_temp=.true., old_dtaudv=.true.; all points ocean (land=F,
...
!!     dump_surface_flux_vt_reference.F90 -o dump_surface_flux_vt_reference
!! Run with JSCA_DUMP_DIR set, then convert with read_dumps.py.

program dump_surface_flux_vt_reference
  ...
  input_nml_file(1) = '&surface_flux_nml do_simple=.true. use_virtual_temp=.true. old_dtaudv=.true. /'
...
end program dump_surface_flux_vt_reference
